...
const TMP_DIR = resolve(ROOT, '.tmp-nextjs');
const PROJECT_DIR = join(TMP_DIR, 'e2e-nextjs');
const STARTER_DIR = resolve(ROOT, 'nextjs/16');
...
describe('create-starter-nextjs e2e', () => {
    beforeAll(() => {

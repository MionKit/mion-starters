...
- Name: smoke.test.ts >> orders showcase displays event timeline
- Location: e2e/smoke.test.ts:46:1
...
Locator: getByText('Event Timeline').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Event Timeline').first()
...
```yaml
- main [ref=e4]:
  - img "Mion logo" [ref=e5]
  - generic [ref=e6]:
    - heading "Mion Orders Showcase" [level=1] [ref=e7]
    - paragraph [ref=e8]:
      - link "Mion" [ref=e9] [cursor=pointer]:
        - /url: https://mion.io
      ...
      - code [ref=e10]: routesFlow
      - text: resolves related data across multiple routes in a single HTTP request.
      - strong [ref=e11]: A fully typed lightweight alternative to GraphQL.
```

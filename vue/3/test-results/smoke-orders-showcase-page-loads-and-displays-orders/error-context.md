...
- Name: smoke.test.ts >> orders showcase page loads and displays orders
- Location: e2e/smoke.test.ts:28:1
...
Locator: getByText('Alice Johnson')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Alice Johnson')
